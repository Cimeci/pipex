...
void ft_parent(t_pipex *pipex, char *file, char *cmd, char **env)
{
	int outfile;
	char *pathname;
...
/////////////////////////////////
	...
	pipex->pipe_fd = malloc(sizeof(int*) * argc - 3);
...
/////////////////////////////////
	...
	// premier processus
	ft_child(pipex, argv[1], argv[2], env);
...
/////////////////////////////////
	...
	// deuxieme processus
	ft_parent(pipex, argv[argc - 1], argv[3], env);
